function write_xml4forces(filename)
    ...
    externalLoads.setAttribute('name', 'Pedaling GRF');
    externalLoads.appendChild(docNode.createTextNode('++'));
...
%     externalForce.appendChild(torqueID);
    ...
    data_src.appendChild(docNode.createTextNode('Unassigned'));
