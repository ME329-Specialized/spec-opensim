function read_cycling_deg(mot_filename, excel_filename, varargin)   
    % pass this function a .mot file which contains timeseries values for
    % right hip, right knee, and right ankle joint angles
    switch nargin
        case 0
            degrees_mot = importdata('cyclingleg_states_degrees.mot', '\t');
        otherwise
            degrees_mot = importdata(mot_filename, '\t');
    end
